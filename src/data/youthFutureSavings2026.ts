...
export const SEO_INTRO = [
  "청년미래적금은 2026년 6월 출시판 기준으로 3년 만기, 월 50만 원 한도, 정부기여금 6~12% 구조가 핵심입니다.",
  "기존 청년도약계좌와 비교할 때 가장 큰 차이는 기간입니다. 청년도약계좌는 5년 장기 상품이고, 청년미래적금은 상대적으로 짧은 3년 만기라 현금흐름 부담이 낮습니다.",
];
