...
export const SALARY_TIER_AFFILIATE = {
  career: {
    ...
    products: [
      {
        title: '이직 바이블',
        desc: '후회 없는 성공적인 이직 플랜, 퇴직사유 경력기술서',
        tag: '이직 필독',
        url: 'https://link.coupang.com/a/efCyLT',
      },
      {
        title: '연봉 3억 주부가 알려주는 영업의 비밀',
        desc: '연봉 협상 실전 가이드. 언제, 어떻게, 얼마나 올릴 수 있는지 단계별 전략 수록',
        tag: '연봉 협상',
        url: 'https://link.coupang.com/a/efCCbQ',
      },
      {
        title: '코스피 1만 넥스트 레벨 ',
        desc: '전 국민 주주 시대 박시동의 실전 투자 비법',
        tag: '재테크',
        url: 'https://link.coupang.com/a/efCEW3',
      },
    ],
  },
};
