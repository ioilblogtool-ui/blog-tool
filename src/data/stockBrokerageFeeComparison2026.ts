...
// 국내주식 수수료 개별 데이터 (2026년 기준, 온라인·모바일 주문 기준)
const domesticFeeData: Record<BrokerId, Pick<BrokerageFeeRow, "domesticBaseFee" | "domesticEventFee" | "includesAgencyFee" | "lifetimeBenefit">> = {
  kiwoom: {
    domesticBaseFee: percentFee(0.015, "0.015% (온라인)", "유관기관 제비용 별도, 영업점·전화 주문은 다름"),
    domesticEventFee: eventOnly("비대면 신규 이벤트", "이벤트 기간·조건 증권사 공식 확인 필요"),
    includesAgencyFee: "no",
    lifetimeBenefit: "conditional",
  },
  toss: {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "이벤트 종료 후 기본 수수료"),
    domesticEventFee: eventOnly("0% (2026년 6월 말까지 이벤트)", "이벤트 기간 종료 후 기본 수수료 적용"),
    includesAgencyFee: "no",
    lifetimeBenefit: "no",
  },
  samsung: {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "온라인 기준, 계좌 종류별 다를 수 있음"),
    domesticEventFee: percentFee(0.0036396, "0.0036396% (비대면 이벤트)", "비대면 신규·타사대체입고 등 이벤트 조건 확인"),
    includesAgencyFee: "no",
    lifetimeBenefit: "conditional",
  },
  mirae: {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "온라인 기준"),
    domesticEventFee: percentFee(0.0036396, "0.0036396% (다이렉트 신규 이벤트)", "다이렉트 앱 신규 계좌 기준, 이벤트 조건 확인"),
    includesAgencyFee: "no",
    lifetimeBenefit: "conditional",
  },
  "korea-investment": {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "온라인 기준"),
    domesticEventFee: percentFee(0.0036396, "0.0036396% (평생 우대)", "비대면 계좌 개설 시 평생 우대 이벤트, 조건 확인 필요"),
    includesAgencyFee: "no",
    lifetimeBenefit: "yes",
  },
  nh: {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "온라인 기준"),
    domesticEventFee: eventOnly("비대면 신규 이벤트 확인 필요", "나무(Namuh) 앱 이벤트 조건 증권사 공식 확인"),
    includesAgencyFee: "no",
    lifetimeBenefit: "conditional",
  },
  kb: {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "온라인 기준"),
    domesticEventFee: percentFee(0.0036396, "0.0036396% (비대면 이벤트)", "이벤트 조건 공식 확인 필요"),
    includesAgencyFee: "no",
    lifetimeBenefit: "conditional",
  },
  shinhan: {
  ...
  hana: {
    domesticBaseFee: percentFee(0.015, "0.015% (기본)", "온라인 기준"),
    domesticEventFee: eventOnly("비대면 신규 이벤트 확인 필요", "이벤트 조건 공식 확인 필요"),
    includesAgencyFee: "no",
    lifetimeBenefit: "conditional",
  },
  daishin: {
...
export const DOMESTIC_FEE_ROWS: BrokerageFeeRow[] = standardDomesticRows.map((row) => ({
  ...
  ...domesticFeeData[row.brokerId],
  domesticRecommendation: row.domesticRecommendation,
  domesticCaution: row.domesticCaution,
}));

// 미국주식 수수료 개별 데이터 (2026년 기준)
export const OVERSEAS_FEE_ROWS: OverseasFeeRow[] = [
  {
    brokerId: "kiwoom",
    brokerName: "키움증권",
    usStockFee: percentFee(0.07, "0.07%", "미국주식 기본 수수료, 이벤트 조건 공식 확인 필요"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(95, "95% 우대 (이벤트)", "이벤트 기간·조건 공식 확인 필요"),
    preAfterMarket: "yes",
    fractionalTrading: "unknown",
    recommendationScore: 4,
    caution: "미국주식 거래 화면과 환전 우대 적용 시간이 중요합니다.",
  },
  {
    brokerId: "toss",
    brokerName: "토스증권",
    usStockFee: percentFee(0.1, "0.1% (기본)", "이벤트 기간 수수료 무료 이벤트 별도 확인"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(100, "100% 우대 (정규시간)", "정규시간 외 50% 우대, 조건 공식 확인 필요"),
    preAfterMarket: "limited",
    fractionalTrading: "limited",
    recommendationScore: 4,
    caution: "소수점·모바일 경험은 편하지만 고급 주문 조건은 따로 확인해야 합니다.",
  },
  {
    brokerId: "samsung",
    brokerName: "삼성증권",
    usStockFee: percentFee(0.09, "0.09% (기본)", "이벤트·계좌 종류별 다를 수 있음"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(90, "90% 우대 (이벤트)", "이벤트 조건 공식 확인 필요"),
    preAfterMarket: "yes",
    fractionalTrading: "limited",
    recommendationScore: 4,
    caution: "연금·ISA와 해외 ETF를 함께 보는 경우 계좌별 조건을 확인해야 합니다.",
  },
  {
    brokerId: "mirae",
    brokerName: "미래에셋증권",
    usStockFee: percentFee(0.07, "0.07% (기본, 다이렉트 신규 90일 0%)", "이벤트 조건 공식 확인 필요"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(90, "90% 우대 (이벤트)", "이벤트 조건 공식 확인 필요"),
    preAfterMarket: "yes",
    fractionalTrading: "limited",
    recommendationScore: 5,
    caution: "해외주식 장기투자자는 수수료보다 환전·배당·세금 안내까지 같이 봐야 합니다.",
  },
  {
    brokerId: "korea-investment",
    brokerName: "한국투자증권",
    usStockFee: percentFee(0.07, "0.07% (기본)", "이벤트 조건 공식 확인 필요"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(90, "90% 우대 (이벤트)", "이벤트 조건 공식 확인 필요"),
    preAfterMarket: "yes",
    fractionalTrading: "limited",
    recommendationScore: 4,
    caution: "해외주식 이벤트 적용 대상과 자동환전 조건을 구분해야 합니다.",
  },
  {
    brokerId: "nh",
    brokerName: "NH투자증권",
    usStockFee: percentFee(0.1, "0.1% (기본)", "이벤트 조건 공식 확인 필요"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(90, "90% 우대 (이벤트)", "이벤트 조건 공식 확인 필요"),
    preAfterMarket: "unknown",
    fractionalTrading: "unknown",
    recommendationScore: 3,
    caution: "은행 연계 편의성과 실제 해외주식 체결 비용을 함께 비교해야 합니다.",
  },
  {
    brokerId: "kb",
    brokerName: "KB증권",
    usStockFee: percentFee(0.1, "0.1% (기본)", "이벤트 조건 공식 확인 필요"),
    usEtfSameFee: "yes",
    fxDiscountRate: percentFee(90, "90% 우대 (이벤트)", "적용 통화·시간대 조건 공식 확인 필요"),
    preAfterMarket: "unknown",
    fractionalTrading: "unknown",
    recommendationScore: 3,
    caution: "환전 우대율이 높아 보여도 적용 통화와 시간대 조건을 확인해야 합니다.",
  },
  {
    brokerId: "shinhan",
    brokerName: "신한투자증권",
    ...
    fractionalTrading: "unknown",
    recommendationScore: 3,
    caution: "모바일 해외주식 이벤트와 기본 수수료표를 동시에 확인해야 합니다.",
  },
  {
    brokerId: "hana",
    brokerName: "하나증권",
    ...
    fractionalTrading: "unknown",
    recommendationScore: 3,
    caution: "은행 연계 환전 조건과 증권 계좌 내 환전 조건이 다를 수 있습니다.",
  },
  {
    brokerId: "daishin",
    brokerName: "대신증권",
    ...
    fractionalTrading: "unknown",
    recommendationScore: 3,
    caution: "해외주식 서비스 범위와 프리·애프터마켓 지원 범위를 확인해야 합니다.",
  },
];

// 신용공여 이자율 (2026년 기준 참고치, 금융투자협회 공시 및 각사 공지 기준 추정)
// 실제 이자율은 담보유형·신용등급·잔고 규모에 따라 달라지며 수시 변경됩니다.
// 반드시 금융투자협회(freesis.kofia.or.kr)와 각 증권사 공식 안내를 확인하세요.
const creditInterestData: Record<BrokerId, Pick<CreditInterestRow, "day1to7" | "day8to15" | "day16to30" | "day31to60" | "day90Plus">> = {
  kiwoom: {
    day1to7: percentFee(5.5, "연 5.5% 내외", "담보유형·등급별 상이, 공시 확인"),
    day8to15: percentFee(7.0, "연 7.0% 내외", "담보유형·등급별 상이, 공시 확인"),
    day16to30: percentFee(8.0, "연 8.0% 내외", "담보유형·등급별 상이, 공시 확인"),
    day31to60: percentFee(9.0, "연 9.0% 내외", "담보유형·등급별 상이, 공시 확인"),
    day90Plus: percentFee(10.0, "연 10.0% 내외", "담보유형·등급별 상이, 공시 확인"),
  },
  toss: {
    day1to7: percentFee(5.5, "연 5.5% 내외", "담보유형·등급별 상이, 공시 확인"),
    day8to15: percentFee(7.0, "연 7.0% 내외", "담보유형·등급별 상이, 공시 확인"),
...
export const CREDIT_INTEREST_ROWS: CreditInterestRow[] = (Object.keys(brokerNames) as BrokerId[]).map((brokerId) => ({
  ...
  ...creditInterestData[brokerId],
  sourceNote: "신용공여 이자율은 구간별·등급별·담보유형별로 달라질 수 있어 금융투자협회(freesis.kofia.or.kr)와 증권사 공시 확인이 필요합니다. 위 수치는 참고 범위이며 실제와 다를 수 있습니다.",
}));
