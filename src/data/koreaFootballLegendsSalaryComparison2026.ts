...
export const KFLS_META = {
  ...
  seoTitle: "손흥민·이강인 연봉 vs 레전드 2026 | 최대 32배 차이",
  seoDescription:
    "손흥민·김민재·이강인과 박지성·차범근 등 레전드 6인의 연봉을 현재가치로 환산해 비교합니다. 세대 간 최대 32배까지 벌어지는 연봉 격차를 데이터로 확인하세요.",
  description:
...
export const KFLS_RELATED_LINKS = [
  { href: "/reports/messi-ronaldo-career-comparison-2026/", label: "메시 vs 호날두 통산 기록·연봉 비교" },
