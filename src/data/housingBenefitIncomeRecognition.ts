...
export const HBIRC_SEO_CONTENT = {
  ...
  intro: [
    "주거급여는 생계급여처럼 소득인정액이 기준선 아래인지부터 확인하지만, 통과한 뒤에는 거주 형태에 따라 받는 방식이 다릅니다. 임차가구는 기준임대료까지 임차료를 보전받고, 자가가구는 주택 노후도에 따른 수선비용을 지원받습니다.",
    "2026년 주거급여 선정기준은 기준 중위소득의 48%입니다. 예를 들어 4인 가구는 월 3,117,474원이 주거급여 선정기준입니다.",
    "기준임대료는 국토교통부가 1~4급지와 가구원 수별로 고시하는 월 임대료 상한선입니다. 실제 임차료가 기준임대료보다 적으면 그 금액을, 많으면 기준임대료까지만 인정합니다.",
    "이 계산기는 소득인정액과 거주 형태를 함께 입력해 주거급여 가능성과 예상 기준임대료·수선비용을 한 번에 확인하도록 만든 자가 점검용 도구입니다.",
    "실제 수급 여부와 지급액은 주민센터 조사, 국토교통부 최신 고시값, 가구 특성에 따라 달라질 수 있습니다.",
  ],
  inputPoints: [
