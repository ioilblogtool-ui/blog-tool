...
const rawApartments: HanamMisaApartmentRow[] = [
  {
    ...
    jeonseRatio: 43.0,
    tradeCountNote: "미사역권 대표 후보로 국토부 재확인이 필요합니다.",
    badge: "확인 필요",
    note: "5호선 미사역 접근성과 미사강변도시 상업지구가 가격에 반영됩니다. 동·층·향에 따른 편차를 확인해야 합니다.",
  },
  {
    ...
    jeonseRatio: 43.0,
    tradeCountNote: "망월천·한강공원권 대표 후보로 국토부 재확인이 필요합니다.",
    badge: "확인 필요",
  ...
  },
  {
    ...
    latestTradeDate: "2026년 6월 후보 기준",
    latestTradeArea: "84㎡",
    previousYearPriceManwon: 114000,
    previousYearPeriod: "2025년 대표 거래 참고",
    fiveYearLowPriceManwon: 77000,
    fiveYearLowDate: "2023년 저점 참고",
    fiveYearLowArea: "84㎡",
    jeonsePriceManwon: 56000,
    jeonseRatio: 43.1,
    tradeCountNote: "한강공원 조망 후보 단지로 국토부 재확인이 필요합니다.",
    badge: "확인 필요",
  ...
  },
  {
    ...
    jeonseRatio: 43.8,
    tradeCountNote: "감일지구 신축 후보로 공식 단지명 재확인이 필요합니다.",
    badge: "확인 필요",
  ...
  },
  {
    ...
    latestTradeDate: "2026년 6월 후보 기준",
    latestTradeArea: "84㎡",
    previousYearPriceManwon: 87000,
    previousYearPeriod: "2025년 대표 거래 참고",
    fiveYearLowPriceManwon: 60000,
    fiveYearLowDate: "2023년 저점 참고",
    fiveYearLowArea: "84㎡",
    jeonsePriceManwon: 43000,
    jeonseRatio: 43.9,
    tradeCountNote: "위례 하남권 대표 후보로 공식 단지명 재확인이 필요합니다.",
    badge: "확인 필요",
