...
export const HIGH_OIL_SEO_CONTENT = {
  ...
  intro: [
    "고유가 피해지원금은 에너지 가격 부담이 큰 취약계층을 대상으로 한 한시 지원입니다. 6월에는 2차 신청 마감이 가까워져 대상 여부와 예상 수령액을 빠르게 확인하는 수요가 높습니다.",
    "이 계산기는 기초생활수급자 1인 55만 원, 차상위계층·한부모가족 1인 45만 원 기준을 적용하고, 비수도권 인구감소지역 추가 지원 가능성을 별도로 표시합니다.",
  ],
  inputPoints: [
