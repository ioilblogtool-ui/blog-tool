...
export const SK_HYNIX_BONUS_2027_SEO_INTRO = [
  "SK하이닉스 임직원이라면 PS, PI라는 두 가지 성과급 용어가 헷갈렸을 것입니다. 하이닉스 성과급은 PS와 PI 구조를 함께 봐야 실제 체감 규모를 이해할 수 있습니다. 두 항목은 산정 기준과 지급 시기가 서로 다르기 때문에 따로 떼어 보는 것이 정확합니다.",
  "특히 2027년 전망은 AI 메모리 수요, 영업이익 흐름, 회사 확정 기준에 따라 크게 달라질 수 있어 단일 금액보다 시나리오 범위로 보는 편이 현실적입니다. HBM 수요가 계속 늘어날지에 따라 2027년 성과급 규모도 함께 출렁일 수 있습니다.",
  "2026년 실제 지급 사례를 먼저 확인하면 2027년 전망을 가늠하는 기준점이 됩니다. 영업이익 재원 배분 방식이 바뀌지 않는다면 실적 흐름에 따라 2027년 PS도 비슷한 패턴으로 움직일 가능성이 있습니다.",
  "이 페이지는 검색에서 바로 들어온 사용자가 2026 지급 구조를 빠르게 이해하고, 2027년 PS 전망을 직급별 금액으로 확인한 뒤 계산기에서 본인 조건으로 이어가도록 구성했습니다. 정확한 지급률은 회사의 공식 발표를 통해 확인하시기 바랍니다.",
];
