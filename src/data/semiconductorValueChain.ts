...
export const VC_META: VcMeta = {
  ...
  fxNote: "원화 환산은 이해를 돕기 위한 단순 환산값입니다. 1달러=1,360원 기준으로 계산했습니다.",
...
export const VC_COMPANIES: ValueChainCompany[] = [
  {
    ...
    flag: "🇺🇸",
    stepId: "design",
    marketCapDisplay: "$4.311T",
    marketCapKrwDisplay: "약 5,863조원",
    marketCapUsd: 4_311_000_000_000,
    revenue: { value: "215.9B USD", krwApprox: "약 293.6조원", period: "FY2026", growth: "+114% YoY" },
    operatingIncome: { value: "134.1B USD", krwApprox: "약 182.4조원", margin: "62%", growth: "5년 전 대비 급증" },
  ...
  },
  {
    ...
    marketCapKrwDisplay: "약 195조원",
    marketCapUsd: 143_240_000_000,
    revenue: { value: "38.7B USD", krwApprox: "약 52.6조원", period: "FY2024", growth: "+9% YoY" },
    operatingIncome: { value: "10.1B USD", krwApprox: "약 13.7조원", margin: "26%" },
  ...
  },
  {
    ...
    flag: "🇺🇸",
    stepId: "design",
    marketCapDisplay: "$1.619T",
    marketCapKrwDisplay: "약 2,202조원",
    marketCapUsd: 1_619_000_000_000,
    revenue: { value: "51.6B USD", krwApprox: "약 70.2조원", period: "FY2024", growth: "+44% YoY" },
    operatingIncome: { value: "12.4B USD", krwApprox: "약 16.9조원", margin: "24%" },
  ...
  },
  {
    ...
    flag: "🇺🇸",
    stepId: "design",
    marketCapDisplay: "$334B",
    marketCapKrwDisplay: "약 454조원",
    marketCapUsd: 333_950_000_000,
    revenue: { value: "25.8B USD", krwApprox: "약 35.1조원", period: "2024", growth: "+14% YoY" },
    operatingIncome: { value: "1.7B USD", krwApprox: "약 2.3조원", margin: "7%" },
  ...
  },
  {
    ...
    flag: "🇳🇱",
    stepId: "equip",
    marketCapDisplay: "$544B",
    marketCapKrwDisplay: "약 741조원",
    marketCapUsd: 544_490_000_000,
  ...
  },
  {
    ...
    flag: "🇺🇸",
    stepId: "equip",
    marketCapDisplay: "$275B",
    marketCapKrwDisplay: "약 374조원",
    marketCapUsd: 274_900_000_000,
    revenue: { value: "18.4B USD", krwApprox: "약 25.0조원", period: "FY2025", growth: "+15% YoY" },
    operatingIncome: { value: "5.5B USD", krwApprox: "약 7.5조원", margin: "30%" },
  ...
  },
  {
    ...
    marketCapKrwDisplay: "약 262조원",
    marketCapUsd: 192_480_000_000,
    revenue: { value: "10.8B USD", krwApprox: "약 14.7조원", period: "FY2024", growth: "+16% YoY" },
    operatingIncome: { value: "3.7B USD", krwApprox: "약 5.0조원", margin: "34%" },
  ...
  },
  {
    ...
    flag: "🇺🇸",
    stepId: "equip",
    marketCapDisplay: "$279B",
    marketCapKrwDisplay: "약 379조원",
    marketCapUsd: 278_610_000_000,
    revenue: { value: "27.2B USD", krwApprox: "약 37.0조원", period: "FY2024", growth: "+2% YoY" },
    operatingIncome: { value: "7.4B USD", krwApprox: "약 10.1조원", margin: "27%" },
  ...
  },
  {
    ...
    flag: "🇹🇼",
    stepId: "foundry",
    marketCapDisplay: "$1.772T",
    marketCapKrwDisplay: "약 2,410조원",
    marketCapUsd: 1_772_000_000_000,
  ...
  },
  {
    ...
    flag: "🇰🇷",
    stepId: "foundry",
    marketCapDisplay: "약 $758B",
    marketCapKrwDisplay: "약 1,031조원",
    marketCapUsd:  757_772_000_000,
  ...
  },
  {
    ...
    flag: "🇰🇷",
    stepId: "memory",
    marketCapDisplay: "약 $449B",
    marketCapKrwDisplay: "약 611조원",
    marketCapUsd:  449_113_000_000,
  ...
  },
  {
    ...
    flag: "🇺🇸",
    stepId: "memory",
    marketCapDisplay: "$471B",
    marketCapKrwDisplay: "약 641조원",
    marketCapUsd: 471_230_000_000,
    revenue: { value: "38.8B USD", krwApprox: "약 52.8조원", period: "FY2024", growth: "+62% YoY" },
    operatingIncome: { value: "9.0B USD", krwApprox: "약 12.2조원", margin: "23%" },
  ...
  },
  {
    ...
    marketCapKrwDisplay: "약 14.8조원",
    marketCapUsd: 10_860_000_000,
    revenue: { value: "7.1B USD", krwApprox: "약 9.7조원", period: "2024", growth: "-5% YoY" },
    operatingIncome: { value: "0.5B USD", krwApprox: "약 0.7조원", margin: "7%" },
