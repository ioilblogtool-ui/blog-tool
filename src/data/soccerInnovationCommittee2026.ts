...
export const SIC_LAUNCH_INFO = {
  ...
  location: "서울 올림픽파크텔",
  purpose:
    "2026 북중미 월드컵을 계기로 제기된 한국 축구 혁신 요구에 대응하고, 중장기 발전 방향을 마련하기 위해 출범했습니다.",
  agenda: ["축구 거버넌스 개선", "유소년 선수 육성 체계", "첨단 기술 시스템 도입", "한국 축구 미래 경쟁력 강화"],
};
...
export const SIC_COMMITTEE_MEMBERS: CommitteeMember[] = [
  ...
  { name: "김대희", role: "위원", isChair: false, affiliation: "교수" },
];
