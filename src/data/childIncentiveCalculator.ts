...
export const CIC_SEO_CONTENT = {
  ...
  intro: [
    ...
    "지급액은 소득이 낮을수록 자녀 1인당 최대 100만 원에 가깝고, 소득이 7,000만 원에 가까워질수록 점차 줄어드는 구조입니다. 자녀가 2명, 3명이면 1인당 산정액에 자녀 수를 곱해 총액이 정해지므로, 자녀 수가 늘어날수록 가구 전체 지급액도 함께 늘어납니다.",
    "재산 기준은 근로장려금과 동일합니다. 재산 합계가 2.4억 원 이상이면 신청이 어렵고, 1.7억 원 이상 2.4억 원 미만이면 산정액의 50%만 지급됩니다. 신청 기한을 놓쳐 기한 후 신청(6/2~12/1)을 하면 산정액의 95%만 지급되어 5% 감액이 추가로 적용됩니다.",
