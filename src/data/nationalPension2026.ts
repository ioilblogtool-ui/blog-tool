...
export const SEO_SECTIONS = [
  ...
  { title: "이 리포트를 보는 방법", body: "이 리포트의 세대별 비교와 기금 전망 수치는 국민연금공단과 정부의 공개 자료를 기준으로 정리한 참고치입니다. 실제 개인의 수령액과 손익분기점은 가입 기간, 소득 수준, 향후 제도 개편에 따라 달라질 수 있으므로 정확한 예상액은 국민연금공단을 통해 확인하는 것을 권장합니다." },
];
