...
export const KLE_META = {
  ...
  seoTitle: "K리그1 구단별 연봉 비교 2026 | 12개 구단 총액·최고연봉·외국인 선수 완전 정리",
  seoDescription:
    "2026년 K리그1 12개 구단의 팀 연봉 총액 순위, 최고 연봉 선수, 포지션별 평균, 주요 외국인 선수 계약을 구단별로 완전 비교합니다. 전북·울산·서울·수원삼성 등 K리그 구단 연봉 구조를 한눈에 정리합니다.",
  description:
    "2026년 K리그1 12개 구단의 연봉 총액 순위, 팀 최고 연봉 선수, 포지션별 평균, 주요 외국인 선수 계약액을 구단별로 완전 분석합니다.",
