...
export const constructionSalaryBonusComparison2026: ConstructionSalaryBonusComparison2026Data = {
  meta: {
    ...
    subtitle: "현대건설, GS건설, 대우건설, 롯데건설, 현대엔지니어링, 삼성E&A, SK에코플랜트 등 주요 건설사의 연봉 순위, 신입 초봉, 성과급, 총보상을 함께 비교하는 리포트입니다.",
  ...
  faq: [
    {
      q: "현대건설 성과급은 어느 정도로 봐야 하나요?",
      a: "이 리포트의 기준 시나리오에서는 현대건설 성과급을 기본 연봉 대비 26% 수준의 비교용 추정치로 둡니다. 실제 지급액은 현장, 평가, 프로젝트 실적, 회사 정책에 따라 달라질 수 있습니다."
    },
    {
      q: "삼성E&A 연봉과 성과급은 건설사 중 어느 위치인가요?",
      a: "삼성E&A는 플랜트·해외수주 성격이 강해 종합건설사와 직접 비교하기보다 별도 축으로 보는 편이 좋습니다. 이 리포트 기준으로는 평균 연봉과 성과급 반영 총보상 모두 상단권에 위치합니다."
    },
    {
