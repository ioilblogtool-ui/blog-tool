...
export const BLAS_SEO_CONTENT = {
  ...
  intro: [
    "기초생활보장 재산 기준은 재산이 있다, 없다로만 판단하지 않습니다. 주거재산, 일반재산, 금융재산, 자동차, 부채를 나누어 보고 지역별 기본재산액도 함께 고려합니다.",
    "전세보증금이나 자가 주택은 주거재산으로 볼 수 있고, 예금과 주식은 금융재산으로 볼 수 있습니다. 자동차는 용도와 가액에 따라 실제 조사에서 중요하게 확인될 수 있습니다.",
    "이 계산기는 재산을 월 소득처럼 환산했을 때 소득인정액에 어느 정도 영향을 주는지 보여주는 자가 점검용 도구입니다.",
    "최종 수급 여부는 실제 공적자료 조회와 주민센터 조사 결과에 따라 달라질 수 있으므로 결과는 신청 전 참고용으로 사용해야 합니다.",
  ],
  inputPoints: [
