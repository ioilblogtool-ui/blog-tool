...
export const newEmployeeSalary2026: NewEmployeeSalary2026Seed = {
  ...
  entries: [
    ...
    },
    {
      ...
      monthlyNetKrwM: 421,
      totalCompM: 8500,
      tags: ["자동차", "성과급", "EV전환", "글로벌"],
      benefits: ["성과급·격려금", "자사차 구매 할인", "사내대출", "복지포인트"],
      summary: "EV 전환 수혜로 성과급 수준이 높아지는 추세. 기본급 외 성과급·격려금 합산 시 총보상은 8천만 원 이상으로 추정됩니다.",
    },
    {
      slug: "ncsoft",
      rank: 5,
  ...
  sectorSummaries: [
    ...
    {
      label: "완성차·조선",
      description: "현대차·기아·현대모비스가 성과급 포함 9,500만 원대로 약진. 조선 3사도 8,500~9,000만 원대로 2026년 처우 회복 뚜렷합니다.",
    },
    {
      label: "배터리·이차전지",
  ...
  patternPoints: [
    ...
    {
      title: "완성차·조선의 약진 — 기본급의 1.5배 성과급",
      body: "현대차·기아·현대모비스가 성과급 포함 9,500만 원대로, 기본급(6,000만 원대) 대비 훨씬 높습니다. 조선 3사(HD현대중공업·한국조선해양·삼호)도 초호황 수주 잔고를 바탕으로 8,500~9,000만 원대로 회복됐습니다.",
    },
    {
