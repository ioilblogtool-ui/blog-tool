...
export const SQE_SEO_INTRO = [
  "삼성전자는 2026년 7월 8일 2분기 잠정실적을, 7월 31일 사업부문별 확정실적을 발표합니다. DS(반도체)부문 영업이익은 OPI 산정의 핵심 변수라, 실적 발표 시즌마다 재직자의 '성과급이 오를까' 관심이 집중됩니다. 이 리포트는 두 발표일을 기준으로 하반기 성과급 흐름을 미리 정리한 자료입니다.",
  "잠정실적과 확정실적은 공개 범위가 다릅니다. 7월 8일 잠정실적은 연결 매출·영업이익만 공개하고, DS·MX·CSS 등 사업부문별 영업이익은 7월 31일 확정실적에서만 확인할 수 있습니다. 성과급의 실질적 근거가 되는 숫자는 확정실적 전까지는 알 수 없다는 뜻이라, 잠정실적만 보고 성과급을 단정하는 것은 이릅니다.",
  "2026년 삼성전자 연간 영업이익 컨센서스는 에프앤가이드 기준 약 297.5조원으로 집계돼 있습니다. 상반기 실적이 이 페이스를 상회하는지, 하회하는지가 하반기 OPI 규모를 가늠하는 1차 기준이 됩니다. DS부문은 2026년 실제 참고 지급률이 47%로 사업부 중 두 번째로 높은 수준이라, 반도체 업황 회복 속도가 재직자 체감에 직접 연결됩니다.",
  "OPI(초과이익분배금)는 사업부문 영업이익이 목표치를 초과할 때 기준급 대비 최대 50% 한도로 지급되고, TAI(목표달성장려금)는 반기 매출·영업이익 목표 달성 여부에 따라 상하반기 별도로 산정됩니다. 두 제도 모두 사업부문 실적이 확정돼야 정확한 지급률을 계산할 수 있어, 지금 시점의 전망은 보수적·기준·공격적 세 시나리오로 나눠 방향성만 제시합니다.",
  "2026년 5월에는 OPI 1.5%와 DS 특별경영성과급 10.5%를 합산한 최대 12% 규모의 잠정합의안이 나온 전례가 있습니다. 이 합의는 2025년 실적을 기준으로 도출된 결과라, 하반기에도 '실적 확정 → 노사 협의 → 지급률 확정' 순서를 따를 가능성이 있습니다. 다만 지금은 확정실적 발표 전이라 정확한 수치보다는 체크포인트 중심으로 상황을 지켜보는 것이 현실적입니다.",
];
