...
export const LKIS_META = {
  ...
  title: "이강인 연봉 2026｜PSG 추정 연봉 59억, 세후 실수령액은 얼마일까",
  seoTitle: "이강인 연봉 2026 | 연봉 59억, 세후 실수령액은",
  seoDescription:
    "이강인의 2026년 PSG 추정 연봉은 원화 약 59억원입니다. 월급·주급·일급·세후 실수령액까지 계산하고 손흥민·김민재 연봉과도 비교합니다.",
  description:
...
export const LKIS_SEO_INTRO = [
  "이강인이 PSG에서 얼마를 받는지 궁금해도 정확한 숫자를 찾기는 쉽지 않습니다. 이강인 연봉은 PSG가 공식 계약서로 공개한 금액이 아니라 비공식 샐러리 DB와 언론 추정치를 바탕으로 확인할 수 있습니다. 따라서 이 페이지에서는 숫자를 확정값으로 쓰지 않고 추정 연봉, 세전 환산, 세후 시뮬레이션으로 구분해 표시합니다.",
  "기본 계산은 2026년 6월 기준 이강인의 PSG 추정 연봉 400만 유로와 1유로 1,485원 환율을 적용합니다. 이 기준이면 원화 연봉은 약 59.4억 원, 월급은 약 4.95억 원, 주급은 약 1.14억 원으로 환산되며, 환율이 바뀌면 원화 환산값도 함께 달라집니다.",
  "세후 실수령액은 프랑스 고소득자 세금과 사회부담금, 계약 구조에 따라 달라집니다. 이 페이지는 단정값 대신 세전 금액의 55~60%를 세후 범위로 보는 단순 시뮬레이션을 제공하며, 실제 수령액은 이 범위 밖에 있을 수도 있습니다.",
  "손흥민, 김민재와의 연봉 비교도 함께 제공합니다. 다만 선수 연봉은 리그, 포지션, 계약 시점, 나이, 구단 내 역할, 보너스 구조가 모두 다르기 때문에 단순 금액 비교를 선수 가치 순위처럼 해석하면 안 됩니다.",
  "PSG 보너스, 출전 수당, 우승 수당, 초상권, 광고 수입은 별도 계약일 수 있으며 이 페이지의 계산에는 포함하지 않습니다. 실제 총수입은 공개 연봉 추정치보다 높거나 낮을 수 있다는 점을 참고하시기 바랍니다.",
];
