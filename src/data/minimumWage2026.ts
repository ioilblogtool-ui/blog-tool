...
export const MWC_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "아직 확정되지 않았습니다. 노동계는 2027년 최저임금 최초 요구안으로 시급 12,000원(월 2,508,000원, 월 209시간 기준)을 제시했습니다. 경영계 요구안과 최저임금위원회 심의를 거쳐 2026년 8월경 확정·고시될 예정입니다. 이 페이지 프리셋에서 '2027 노동계 요구안'을 선택하면 시급 12,000원 기준 월급과 세후 실수령액을 미리 확인할 수 있습니다.",
  },
  {
    question: "노동계 요구안 시급 12,000원이면 월급은 얼마인가요?",
    answer: "시급 12,000원 기준 주 40시간·월 209시간 적용 시 세전 월급은 2,508,000원입니다. 4대보험과 소득세를 공제하면 세후 실수령 추정액은 약 220만원대 초반 수준입니다. 정확한 금액은 이 페이지 프리셋에서 직접 확인하세요.",
  },
];

export const SEO_INTRO = [
  "2026년 적용 최저임금은 시간당 10,320원입니다. 주 40시간 근무와 유급주휴 8시간을 포함한 월 209시간 기준 월 환산액은 2,156,880원입니다.",
  "이 계산기는 시급, 주 소정근로시간, 주휴수당 포함 여부를 바탕으로 일급·주급·월급·연봉을 환산합니다. 직접 시급을 입력하면 2026년 최저임금 충족 여부도 바로 확인할 수 있습니다.",
  "2027년 최저임금 협상이 진행 중입니다. 노동계는 시급 12,000원(월 2,508,000원, 월 209시간 기준)을 최초 요구안으로 제시했습니다. 계산기 상단 프리셋에서 '2027 노동계 요구안'을 선택하면 시급 12,000원 기준 월급·세후 실수령액을 바로 확인할 수 있습니다.",
  "세후 실수령액은 4대보험과 간이세액을 단순 적용한 추정값입니다. 실제 원천징수액은 부양가족, 비과세 항목, 회사 급여 처리 방식에 따라 달라질 수 있습니다.",
];
...
export const SEO_CRITERIA = [
  ...
  "2027 노동계 요구안(시급 12,000원)은 최초 요구 수치이며 확정 최저임금이 아닙니다. 실제 2027년 최저임금은 최저임금위원회 심의·의결을 거쳐 2026년 8월경 고시됩니다.",
];
