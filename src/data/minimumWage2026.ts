...
export const SEO_INTRO = [
  ...
  "2027년 최저임금 협상이 진행 중입니다. 노동계는 시급 12,000원(월 2,508,000원, 월 209시간 기준)을 최초 요구안으로 제시했습니다. 계산기 상단 프리셋에서 '2027 노동계 요구안'을 선택하면 시급 12,000원 기준 월급·세후 실수령액을 바로 확인할 수 있어, 협상 결과를 미리 가늠해보는 용도로도 활용할 수 있습니다.",
