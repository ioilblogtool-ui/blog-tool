...
export const WIC_SEO_CONTENT = {
  ...
  intro: [
    ...
    "이 계산기는 가구유형, 소득, 재산, 신청유형을 입력해 두 가지 감액을 모두 반영한 예상 지급액을 계산합니다. 다만 산정표의 구간 경계값과 최대 지급액은 매년 조정될 수 있어, 정확한 최종 지급액은 국세청 홈택스 모의계산 또는 실제 심사 결과로 다시 확인하는 절차를 거치는 것이 안전합니다.",
  ],
  inputPoints: [
