...
export const MW27_FAQ = [
  {
    ...
    a: "최저임금위원회가 매년 6~7월 심의를 거쳐 8월 5일 이전 고시합니다. 2027년 적용 최저임금은 2026년 7월 중 발표 예정입니다. 발표 즉시 이 계산기에 반영됩니다.",
  },
  {
    q: "주휴수당은 어떤 경우에 받나요?",
    a: "1주 소정근로시간이 15시간 이상인 근로자에게 유급 주휴일(8시간분)이 주어집니다. 주 5일 8시간 기준 월급 계산 시 주휴수당이 포함되어 실질 시급은 명목 시급보다 약 20% 높게 됩니다.",
  },
  {
    q: "한국 최저임금은 세계 몇 위인가요?",
    a: "단순 달러 환산으로는 OECD 중하위권(약 20위)이지만, 물가를 반영한 PPP 기준으로는 중위권(약 14~15위)입니다. 일본보다는 높고 서유럽 주요국보다는 낮습니다.",
  },
  {
    q: "빅맥 지수로 구매력을 비교하는 이유는?",
    a: "단순 시급을 달러로 환산하면 물가 차이가 반영되지 않습니다. '1시간 일해서 빅맥을 몇 개 살 수 있나'로 비교하면 각국의 실질 생활 수준을 직관적으로 알 수 있습니다. 한국은 약 1.4개로 호주(2.1개), 영국(2.6개)보다 낮습니다.",
  },
  {
    q: "최저임금 위반 시 어떻게 되나요?",
    a: "최저임금법 위반 시 3년 이하 징역 또는 2천만원 이하 벌금에 처해집니다. 고용노동부 고객상담센터(☎1350)에 신고할 수 있습니다.",
  },
];
