...
export const SBFC_META = {
  title: "증권사 수수료 계산기 2026 — 내 거래 패턴으로 연간 수수료 비교 | 비교계산소",
  description:
    "1회 거래금액과 월 거래 횟수를 입력하면 키움·토스·삼성·미래에셋 등 주요 증권사별 연간 수수료를 자동 계산합니다. 국내주식·미국주식 선택 후 나에게 가장 저렴한 증권사를 바로 확인하세요.",
} as const;
