...
export const FAQ_ITEMS = [
  {
    ...
    a: 'WD에서 분사한 낸드 플래시 전문 기업으로, AI 데이터센터의 스토리지 수요 급증과 낸드 공급 타이트 상황이 맞물려 연초 대비 820% 폭등했습니다. 애플의 메모리 비용 경고 이후 NAND 희소성이 부각되며 추가 급등.',
  },
  {
    q: '엔비디아가 AI 대장주인데 왜 수익률이 낮나요?',
    a: '엔비디아는 2024~2025년에 이미 수백 % 상승한 기저 효과로 2026년 상반기 추가 상승폭이 제한됐습니다. 수익률보다 시가총액(약 5,100조원)에서 압도적 1위를 유지합니다.',
  },
  {
    q: 'HBM이란 무엇인가요?',
    a: '고대역폭메모리(High Bandwidth Memory)의 약자. AI 가속기에 탑재되는 초고속 D램으로, 엔비디아 H100·B200에 SK하이닉스가 독점 공급하며 상반기 주가 상승의 핵심 동인이 됐습니다.',
  },
  {
    q: '반도체 ETF vs 개별 주식, 어떤 게 더 나은가요?',
    a: 'ETF는 분산 투자로 변동성이 낮고, 개별 주식은 고수익 기회가 있지만 리스크도 큽니다. SNDK·MU를 미리 담았다면 ETF 대비 훨씬 높은 수익이 가능했지만 사전 예측은 매우 어렵습니다.',
  },
  {
    q: '2026 하반기에도 반도체 주식이 오를 수 있나요?',
    a: '다수 애널리스트는 AI 인프라 투자 사이클이 2027년까지 이어진다고 전망합니다. 다만 상반기 급등에 따른 밸류에이션 부담, 미중 무역 갈등, 금리 변수 등 리스크 요인도 존재합니다.',
  },
  {
    q: 'ASML은 네덜란드 회사인데 왜 포함됐나요?',
    a: 'ASML은 EUV 장비를 세계에서 유일하게 생산하는 반도체 장비 독점 기업입니다. 나스닥에도 상장되어 있으며, 모든 첨단 팹은 ASML 없이는 운영이 불가능합니다.',
  },
];
