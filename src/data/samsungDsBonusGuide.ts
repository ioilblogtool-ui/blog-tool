...
export const AGREEMENT_FAQ: GuideFaq[] = [
  {
    question: "삼성전자 TAI는 무엇인가요?",
    answer:
      "TAI는 목표달성장려금의 줄임말로, 사업부·조직이 반기(상반기·하반기) 매출·영업이익 목표를 달성했는지에 따라 상반기와 하반기에 각각 지급되는 성과급입니다. 연 1회 지급되는 OPI(초과이익분배금)와는 지급 주기와 산정 기준이 다릅니다.",
  },
  {
...
export const SEO_INTRO = [
  "삼성전자 성과급 지급 시즌마다 TAI, OPI, 특별성과급이라는 용어가 헷갈려 정확한 의미를 모르고 넘어가는 경우가 많습니다. 삼성전자 성과급은 단일 금액으로 보기보다 TAI, OPI, 특별성과급, 복지성 항목을 나눠 봐야 실제 구성을 이해할 수 있습니다.",
  "특히 DS, DX, MX는 같은 삼성전자 안에서도 사업부 실적과 지급 기준이 달라 연봉이 같아도 총보상 체감액이 달라질 수 있습니다. 어느 사업부에 속해 있는지가 성과급 규모에 직접적인 영향을 미치는 가장 큰 변수입니다.",
  "TAI(목표달성장려금)는 반기 단위로 상반기·하반기 각각 지급되고, OPI(초과이익분배금)는 연 1회 지급되는 구조로 지급 시기와 산정 기준이 서로 다릅니다. 이 둘을 합쳐 연간 총성과급 규모를 가늠하는 것이 정확한 비교 방법입니다.",
  "이 페이지는 검색에서 바로 들어온 사용자가 계산 기준을 이해하고, 삼성 성과급 계산기에서 본인 조건으로 이어가도록 구성했습니다. 정확한 지급률과 지급 시기는 회사의 공식 발표를 통해 확인하는 것이 안전합니다.",
];
