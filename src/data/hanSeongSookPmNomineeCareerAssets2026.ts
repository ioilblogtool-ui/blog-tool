...
export const HSSR_META = {
  ...
  title: "한성숙 국무총리 후보자 프로필 2026｜경력·재산 223억 정리",
  seoTitle: "한성숙 국무총리 후보자 프로필 2026 | 경력·재산 223억",
  seoDescription:
    "한성숙 국무총리 후보자 프로필을 한눈에 정리했습니다. 네이버 대표이사, 중기부 장관 경력과 공개 재산 223억원, 총리 연봉·인사청문회 절차까지 확인하세요.",
  description:
    "한성숙 국무총리 후보자 프로필을 엠파스 창립 멤버, 네이버 대표이사, 중소벤처기업부 장관 경력과 공개 재산 중심으로 정리한 인터랙티브 리포트입니다.",
