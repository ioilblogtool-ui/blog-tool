...
export const reports: ReportMeta[] = [
  ...
  },
  {
    ...
    title: "K리그 연봉순위 2026 | 12구단 총액·구단순위 비교",
    description: "2026년 K리그1 12개 구단의 연봉 총액 순위와 구단순위 흐름을 정리했습니다. 구스타보·나상호·세징야 최고 연봉과 KBO 연봉 비교까지 함께 확인할 수 있습니다.",
    order: 37.12,
  ...
  },
  {
    ...
    title: "경비 vs 미화 vs 요양보호사 2026 | 60대 일자리 월급 한눈에 비교",
    description: "경비·미화·요양보호사·주차관리·노인일자리 월급, 준비기간, 체력부담을 한 화면에서 비교합니다. 노인일자리 공공형·사회서비스형 지원금 비교 포함.",
    order: 67,
    badges: ["60대 일자리", "경비", "미화", "요양보호사", "2026"],
  },
  {
  ...
  },
  {
    ...
    title: "2026 코스피 사이드카 41회 | 2008 금융위기 26회 비교",
    description: "2026년 7월 24일 기준 코스피 사이드카는 41회 발동됐습니다. 매수·매도 발동 횟수, 2008년 금융위기와의 비교, 코스닥·서킷브레이커와의 차이를 정리합니다.",
    order: 80,
  ...
  },
  {
    ...
    order: 77,
    badges: ["신규", "삼성", "지분구조", "2026"],
  },
  {
    slug: "sk-group-ownership-2026",
    title: "SK그룹 지분구조 2026 완전 정리 | SK㈜·SK스퀘어·SK하이닉스 지배관계",
    description: "최태원 회장 지분부터 SK㈜→SK스퀘어→SK하이닉스 연결까지 지분구조를 정리. 중간지주 구조와 상장 계열사 목록 포함.",
    order: 77.1,
    badges: ["신규", "SK", "지분구조", "2026"],
  },
  {
    slug: "hyundai-motor-group-ownership-2026",
    title: "현대차그룹 지분구조 2026 완전 정리 | 현대모비스·현대차·기아 순환출자",
    description: "정의선 회장 지분부터 현대모비스→현대차→기아로 돌아오는 순환출자 고리까지 정리. 4대그룹 중 유일하게 남은 구조입니다.",
    order: 77.2,
    badges: ["신규", "현대차", "지분구조", "2026"],
  },
  {
    slug: "lg-group-ownership-2026",
    title: "LG그룹 지분구조 2026 완전 정리 | ㈜LG·LG전자·LG화학 지배관계",
    description: "구광모 회장 지분부터 ㈜LG→LG전자·LG화학·LG유플러스로 뻗는 순수지주회사 구조를 정리. 상장 계열사 12개 목록 포함.",
    order: 77.3,
    badges: ["신규", "LG", "지분구조", "2026"],
  },
  {
    slug: "hanwha-group-ownership-2026",
    title: "한화그룹 지분구조 2026 완전 정리 | 김승연 3형제 인적분할 지배관계",
    description: "김승연 회장과 3형제 지분부터 2026년 진행 중인 ㈜한화 인적분할까지 정리. 방산·조선 계열과 유통·레저 계열 분리 구조 포함.",
    order: 77.4,
    badges: ["신규", "한화", "지분구조", "2026"],
  },
  {
    slug: "lotte-group-ownership-2026",
    title: "롯데그룹 지분구조 2026 완전 정리 | 롯데지주·일본 롯데 연결 구조",
    description: "신동빈 회장 지분부터 일본 롯데홀딩스→호텔롯데→롯데지주로 이어지는 연결까지 정리. 상장 계열사 11개 목록 포함.",
    order: 77.5,
    badges: ["신규", "롯데", "지분구조", "2026"],
  },
  {
    slug: "hd-hyundai-group-ownership-2026",
    title: "HD현대그룹 지분구조 2026 완전 정리 | 조선·에너지·전기 지배관계",
    description: "정몽준·정기선 지분부터 조선(중간지주)·오일뱅크·일렉트릭(직접 보유) 혼합형 구조까지 정리. 상장 계열사 7개 목록 포함.",
    order: 77.6,
    badges: ["신규", "HD현대", "지분구조", "2026"],
  },
  {
    slug: "ls-group-ownership-2026",
    title: "LS그룹 지분구조 2026 완전 정리 | ㈜LS·E1·인베니 3개 지주사",
    description: "구자열·구자은 지분부터 ㈜LS·E1·인베니가 지분 없이 동일인만 공유하는 사촌경영 구조까지 정리. 상장 계열사 10개 목록 포함.",
    order: 77.7,
    badges: ["신규", "LS", "지분구조", "2026"],
  },
  {
    slug: "doosan-group-ownership-2026",
    title: "두산그룹 지분구조 2026 완전 정리 | 지주회사 지위 반납한 이유",
    description: "박정원 회장 지분부터 2025년 지주회사 지위를 반납한 이유, 두산로보틱스·두산밥캣 재편까지 정리. 상장 계열사 7개 목록 포함.",
    order: 77.8,
    badges: ["신규", "두산", "지분구조", "2026"],
  },
  {
    slug: "group-ownership-hub-2026",
    title: "대한민국 대기업 9개 그룹 지분구조 비교 2026 | 지주회사 여부 한눈에",
    description: "삼성·SK·현대차·LG·한화·롯데·HD현대·LS·두산 9개 그룹의 지주회사 여부, 계열사·상장사 수, 지배구조 특징을 비교합니다.",
    order: 77.9,
    badges: ["신규", "지분구조", "비교", "2026"],
  },
  {
    slug: "real-estate-tax-reform-2026",
    title: "2026 부동산 세제개편 전망 | 종부세·장특공제 변경 가능성",
    description: "2026년 부동산 세제개편 논의를 정리했습니다. 종부세 공정시장가액비율, 주택 수에서 보유가액 중심 과세 전환, 장기보유특별공제 개편 가능성과 1주택자·다주택자 영향을 확인하세요.",
    order: 78,
