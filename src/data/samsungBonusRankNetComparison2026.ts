...
export const seoIntro = [
  ...
  "직급별 비교표를 보면 같은 사업부라도 직급에 따라 성과급 규모가 어떻게 달라지는지, 그리고 세전과 세후의 차이가 직급별로 얼마나 벌어지는지 함께 확인할 수 있습니다. 자사주 지급 구조까지 포함하면 현금성 성과급만 볼 때보다 총보상 규모가 더 커집니다.",
  "다만 이 리포트의 수치는 노사 협의안과 업계 추정을 기반으로 한 시뮬레이션이며, 삼성전자의 최종 확정 지급률이 아닙니다. 정확한 지급률과 지급 시기는 회사의 공식 발표를 통해 확인하는 것이 안전합니다.",
];
