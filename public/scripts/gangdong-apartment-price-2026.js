(function () {
  ...
  function renderProfitCard(apartment) {
    ...
    setText('[data-gdap-field="areaGroup"]', apartment.areaGroup + " · " + apartment.legalDongLabel);
    ...
    setText('[data-gdap-field="supply"]', apartment.supplyNote);
    setText('[data-gdap-field="redevelopment"]', apartment.redevelopmentNote);
